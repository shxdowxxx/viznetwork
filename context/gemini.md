...
- Firebase SDK version is 11.6.0 (ES module CDN import) — significantly newer than the compat v10.12.2 used in siznexus-development. Do not mix compat and modular SDK syntax.
